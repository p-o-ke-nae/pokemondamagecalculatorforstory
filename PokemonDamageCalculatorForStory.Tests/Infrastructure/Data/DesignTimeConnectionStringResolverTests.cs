...
namespace PokemonDamageCalculatorForStory.Tests.Infrastructure.Data;
...
public sealed class DesignTimeConnectionStringResolverTests
{
    ...
    private sealed class ResolverTestScope : IDisposable
    {
        ...
        {
            RootPath = Path.Combine(Path.GetTempPath(), "PokemonDamageCalculatorForStoryResolverTests", Guid.NewGuid().ToString("N"));
